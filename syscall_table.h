...
static const SC_ENTRY SYSCALL_TABLE[] = {
    ...
    { 0x005A, "NtCreateMutant",
      SC_NO_LINUX,         "(futex)",         SC_STUB        },
    { 0x00B4, "NtReleaseMutant",
      SC_NO_LINUX,         "(futex)",         SC_STUB        },
    { 0x0048, "NtCreateEvent",
      SYS_eventfd2,        "eventfd2",        SC_STUB        },
    { 0x00D8, "NtSetEvent",
      SC_NO_LINUX,         "(eventfd write)", SC_STUB        },
    { 0x00E2, "NtResetEvent",
      SC_NO_LINUX,         "(eventfd read)",  SC_STUB        },
    ...
    { 0x0060, "NtQuerySystemTime",
      SYS_clock_gettime,   "clock_gettime",   SC_STUB        },
